					...
					<td height="80" valign="top" background="../../images/sub03/bg_01.gif" style="padding:28px 0px 0px 0px">
						...
						<table border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td style="padding:0px 0px 0px 3px"><img src="../../images/sub03/btn_next.gif" alt="다음년" onclick="location.href='<?=$_SERVER['PHP_SELF']?>?pno=<?=$pno?>&toYear=<?=$mNextYear?>&toMonth=1&gubun=<?=$gubun?>&msChk=<?=$msChk?>&search=<?=$search?>&keyword=<?=$keyword?>&edu_kind=<?=$edu_kind?>'" style="cursor:hand"	 ><?
														if($_SESSION['masterSession'])
														{
															echo "&nbsp<img src='../../images/btn/btn_print.gif' alt='인쇄' onClick='window.print();return false;'>";
														}
													?></td>
							</tr>
						</table>
