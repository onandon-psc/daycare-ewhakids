	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td width="51" align="center" class="btitle1">번호</td>
					<td width="454" align="center" class="btitle1">제목</td>
					<? if($row_page[BD_WRITE] != "9"){ ?>
					<td width="82" align="center" class="btitle1">작성자</td>
					<? } ?>
					<td width="84" align="center" class="btitle1">등록일</td>
					<td width="51" align="center" class="btitle1">조회</td>
				</tr>
				<tr>
					<td height="1" colspan="<?=$colspan?>" class="bline2"></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="82" align="center" class="bcontent"><?=$row[board_name]?></td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="51" align="center" class="bcontent"><?=$no?></td>
					<td width="454" class="bcontent"><span onclick="_viewLink('<?=$row[board_idx]?>','<?=$secretValue?>');" style="cursor:pointer"><?if($row[board_depth] != "1"){ for($x=1;$x<$row[board_depth];$x++){ echo"&nbsp;";} echo"$re_img"; }?><?=trim_text($row[board_subject], $strnum)?><?=$new_img?><?=$secret_img?></a></td>
					<? if($row_page[BD_WRITE] != "9"){ ?>
					<td width="82" align="center" class="bcontent"><?=$row[board_name]?></td>
					<? } ?>
					<td width="84" align="center" class="bcontent"><?=date("Y.m.d", $row[board_regdate]);?></td>
					<td width="51" align="center" class="bcontent"><?=number_format($row[board_hit])?></td>
				</tr>
				<tr>
					<td height="1" colspan="<?=$colspan?>" class="bline3"></td>
				</tr>
