<?
    ...
    $tableName	= "ddm_connection_count";

	$listQuery		= "SELECT * FROM $tableName ORDER BY regdate DESC";
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
    <TR height="30">
        <TD bgcolor="#ececec">&nbsp;&nbsp;<img src="/images/admin/menu.gif"> 통계 > <b>홈페이지 접속통계</b></TD>
    </TR>
    <TR>
        <TD height="15"></TD>
    </TR>
